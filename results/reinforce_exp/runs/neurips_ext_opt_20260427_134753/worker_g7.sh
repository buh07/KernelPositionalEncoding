...
CUDA_VISIBLE_DEVICES=7 .venv/bin/python -u reinforce_exp/exp_new_r12_mistral.py \
  --device cuda:0 --output-root "$RUN_ROOT/exp_new_r12_ordering_control_shards/mistral_a" \
